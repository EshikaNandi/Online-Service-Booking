...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-down m-0">
                        <a href="team.html" class="dropdown-item">Topic</a>
                        <a href="testimonial.html" class="dropdown-item">Content</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
    ...
    <main class="container" style="margin-top: 60px;">
        <?php
        $subid= $_POST['subid'];
        $sub = "SELECT * FROM contents WHERE subject_id = '$subid'";
        $subrs = mysqli_query($conn, $sub) or die(mysqli_error($conn));
        if (mysqli_num_rows($subrs) > 0) {

            $subrec = mysqli_fetch_assoc($subrs);
            echo "<h1>".$subrec['content_title']."</h1>";
            echo "<h2>".$subrec['topic']."</h2>";
            echo $subrec['description'];
        }else{
